<?php
    include("conexion.php");
        ...
        $sql = "SELECT * FROM productos WHERE FechaHora BETWEEN '$fechaInicio' AND '$fechaFin'";
    ...
    <div class="wrapper ">
        ...
        <div class="sidebar-wrapper">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="consulcomp.php">
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <h4 class="card-title ">Compras por periodo</h4>
