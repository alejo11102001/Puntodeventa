                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><span type="text" class="form-control" id="Proveedor" name="Proveedor" title="No tienes autorización para editar este campo" contenteditable="false"><?php echo $row['proveedor']; ?></span></td>
