      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="turnosp.php">
              <i class="material-icons">bookmark</i>
              <p>Turnos</p>
            </a>
          </li>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header card-header-primary">
                    ...
                    <p class="card-category">Asignar turno</p>
                  </div>
                  </div>
                  <br>
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-3">
                          ...
                          <label class="bmd-label-floating">Empleado</label>
                            <select name="Empleado" id="Empleado" class="form-control">
                              <?php
                                while($fila = $resul2->fetch_assoc()): 
                                  $PrimerNombre = $fila['PrimerNombre'];?>
                                  <option class="option-select negro" value="<?php echo $PrimerNombre?>"><?php echo $PrimerNombre?>
                                <?php endwhile; ?>
                            </select>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            <label class="bmd-label-floating">Dia</label>
                            <input type="text" class="form-control" id="Dia" name="Dia" required/>   
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            <label class="bmd-label-floating">Hora inicio</label>
                            <input type="time" class="form-control" id="Hora-i" name="Hora-i" required/> 
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            <label class="bmd-label-floating">Hora fin</label>
                            <input type="time" class="form-control" id="Hora-f" name="Hora-f" required/>  
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <select name="Local" id="Local" class="form-control">
                              <?php
                                while($fila = $resul->fetch_assoc()): 
                                  $NombreLocal = $fila['nombre'];?>
                                  <option class="option-select negro" value="<?php echo $NombreLocal?>"><?php echo $NombreLocal?>
                                <?php endwhile; ?>
                            </select>
                          </div>
                        </div>
