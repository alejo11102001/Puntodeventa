    ...
    <div class="sidebar" data-color="green" data-background-color="black" data-image="../assets/img/Compras.avif">
      <div class="logo"><a href="" class="simple-text logo-normal">
        ...
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="agregarproveedor.php?idUs=<?php echo $idUs?>">
              ...
              <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                <div class="card card-stats">
                  ...
                  <div class="card-footer">
                    ...
                    <a class="nav-link" href="modificarCantidades.php?idProd=<?php echo $row['IDProducto']?>&idUs=<?php echo $idUs?>">
                      <i class="material-icons" title="Agregar cantidad">edit</i>
                    </a>
                  </div>
                </div>
              </div> <?php } ?>
