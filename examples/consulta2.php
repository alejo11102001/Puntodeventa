<?php
    ...
    $consulta = "SELECT Nombre, SUM(valortotal) AS TotalCompras FROM ventas GROUP BY Nombre ORDER BY TotalCompras DESC LIMIT 10";
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title ">Clientes que mas compran</h4>
